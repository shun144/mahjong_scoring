...
import { settingsRepository as defaultSettingsRepository } from "../infrastructure/settingsRepository.instance";
...
export function useSettings(): SettingsContextValue {
  ...
  if (!ctx) {
    throw new Error("useSettingsはSettingsProviderの内側でのみ使用できます。");
  }
  return ctx;
}
